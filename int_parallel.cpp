...
int calculateE(int iN,  int iTotientN){
    int i =0;
    int iE=7;
    while(i < (iN - 1))
	{
    ...
    int a= sqrt(iTotientN+1);
    return a;
}
int calculateD(int iN, int iE, int iTotientN){
    int i = 1;
    int iD;
	while(i < iN)
	{
...
int main(int argc, char *argv[])
{
	...
	iE = calculateE(iN,iTotientN);
	iD=calculateD(iN,iE,iTotientN);
	int endindex =iE;
